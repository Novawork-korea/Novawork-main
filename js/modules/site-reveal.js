(() => {
  ...
  if (root.dataset.nwRevealController === "v40") return;
  root.dataset.nwRevealController = "v40";
  ...
  const dispatchIntro = () => {
    ...
    try { document.dispatchEvent(new CustomEvent("novawork:logo-intro-start", { detail: { source: "site-reveal-v40" } })); } catch (error) {}
    try { window.dispatchEvent(new CustomEvent("novawork:logo-intro-start", { detail: { source: "site-reveal-v40" } })); } catch (error) {}
  };
